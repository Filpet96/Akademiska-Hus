...
public partial class MainView: Fuse.App
{
    ...
    void InitializeUX()
    {
        ...
        shadow_Color_inst = new MaterialDrawer_FuseControlsShadow_Color_Property(shadow, __selector0);
        sidebarFade = new global::Fuse.Controls.Rectangle();
        sidebarFade_Opacity_inst = new MaterialDrawer_FuseElementsElement_Opacity_Property(sidebarFade, __selector1);
        var temp = new global::Fuse.iOS.StatusBarConfig();
        var temp1 = new global::Fuse.Controls.EdgeNavigator();
        sidebar = new global::Fuse.Controls.Panel();
        var temp2 = new global::Fuse.Navigation.ActivatingAnimation();
        var temp3 = new global::Fuse.Animations.Change<float4>(shadow_Color_inst);
        var temp4 = new global::Fuse.Animations.Change<float>(sidebarFade_Opacity_inst);
        var temp5 = new global::Fuse.Drawing.StaticSolidColor(float4(0.2156863f, 0.2784314f, 0.3098039f, 1f));
        ...
        var temp11 = new global::Hamburger();
        ...
        sidebar.Background = temp5;
        sidebar.Children.Add(shadow);
        sidebar.Children.Add(temp2);
        shadow.Angle = 180f;
        shadow.Distance = 8f;
        shadow.Size = 16f;
        ...
        temp3.Value = float4(0f, 0f, 0f, 0.2666667f);
        temp4.Value = 1f;
        temp6.Color = float4(0.1490196f, 0.1960784f, 0.2196078f, 1f);
        temp6.Children.Add(sidebarFade);
        ...
        temp7.Color = float4(0.1294118f, 0.5882353f, 0.9529412f, 1f);
        ...
        temp8.Distance = 1f;
        temp8.Size = 3f;
        temp10.Height = new Uno.UX.Size(56f, Uno.UX.Unit.Unspecified);
